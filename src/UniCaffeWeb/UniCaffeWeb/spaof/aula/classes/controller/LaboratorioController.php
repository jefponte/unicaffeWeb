...
class LaboratorioController{
    ...
    <caption>Tempo de Utilização Já Oferecido Desde O início</caption>
		...
		foreach($laboratorios as $laboratorio){
			...
			$sql = "SELECT sum(tempo_usado) as tempo_total FROM 
				acesso INNER JOIN 
				maquina ON acesso.id_maquina = maquina.id_maquina INNER JOIN 
				laboratorio_maquina ON laboratorio_maquina.id_maquina = maquina.id_maquina INNER JOIN 
				laboratorio ON laboratorio_maquina.id_laboratorio = laboratorio.id_laboratorio 
				WHERE laboratorio.id_laboratorio = '$idDoLaboratorio'";
	...
	public function telaVisualizacao()
	{
		...
		foreach($lista as $elemento){
			...
			if(strtolower($elemento->getNome()) != "labteste")
