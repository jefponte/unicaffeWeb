...
public class Desktop {
	...
	public Desktop(String caminho, String nomeDeUsuario) {
		...
		listaPersonalizada.add(new Registro("HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\User Shell Folders", "{374DE290-123F-4565-9164-39C4925E467B}", Registro.REG_SZ, caminho+"\\public\\Downloads", "%PUBLIC%\\Downloads","Muda a pasta da �rea de trabalho p�blica. "));
		...
		listaPersonalizada.add(new Registro("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\User Shell Folders", "{374DE290-123F-4565-9164-39C4925E467B}", Registro.REG_EXPAND_SZ, caminho+"\\"+nomeDeUsuario+"\\"+"Desktop", "%USERPROFILE%\\Downloads","Muda a pasta da �rea de trabalho do usu�rio corrente. "));
