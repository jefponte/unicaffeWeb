...
//		DAO daoPG = new DAO(DAO.TIPO_PG_SIMULACAO_SIGAA);
//		
//		//
//		try {
...
//			PreparedStatement ps = dao.getConexao().prepareStatement("SELECT * FROM usuarios_unicafe");
...
//				int nivel = 1;
//				
//				PreparedStatement psInsert = daoPG.getConexao().prepareStatement("INSERT into usuarios_unicafe(nome, email, login, senha) VALUES(?,?,?,?)");
...
//
//				psInsert.execute();
//				System.out.println("Aweee Inseri a "+nome);
//				
//				
//			}
//
