...
/**
 * Representa o acesso atual da máquina, com informação de tempo utilizado,
 * estado do acesso e usuário atual.
 * 
...
public class Acesso {
	...
	/**
	 * Estado do acesso. Será preenchido com as constantes desta classe. Poderá ser:
	 * STATUS_EM_UTILIZACAO para informar que o acesso está em utilizaçãoi.
	 * STATUS_DISPONIVEL para informar que o acesso está disponível para o próximo
	 * usuário.
	 */
	private int status;
	/**
	...
	private String ip;
	/**
	 * Esta significa que o acesso está em utilização. Constante para ser usada no
	 * atributo status.
	 */
	...
	/**
	 * Constroi um objeto acesso. Além de atribuir valores default. status default
	 * STATUS_DISPONIVEL tempo usado 0
	 * 
	 */
	...
	/**
	 * Começa a contar o tempo de acesso. Contagem continuará enquanto status for
	 * STATUS_EM_UTILIZACAO.
	 */
	public void contar() {
	...
	public String toString() {
		String acesso = "usuario: " + this.usuario.getId() + ", hora Acesso Long: " + this.horaInicial
				+ ", Tempo Usado: " + this.tempoUsado + ", " + this.tempoDisponibilizado + "BLZ\n";
		return acesso;
	}
