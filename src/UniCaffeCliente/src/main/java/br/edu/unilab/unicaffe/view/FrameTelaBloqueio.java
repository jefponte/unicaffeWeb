...
public class FrameTelaBloqueio extends JFrame {
	...
	/**
	 * @return label que indica a versão.
	 */
	public JLabel getLaBelVersao() {
		return this.labelVersao;
	}

	/**
	 * Cria tela de Bloqueio. Tela de login.
	 */
	public FrameTelaBloqueio() {
		...
		labelLogo2.setIcon(new ImageIcon(getClass().getResource("/images/" + "logo_unicaffe_p.png")));
		labelLogo2.setBounds(33, 10, 256, 55);
		panelForm2.add(labelLogo2);

		JButton button = new JButton("");
		button.setIcon(new ImageIcon(getClass().getResource("/images/" + "user.png")));
		...
		button2.setIcon(new ImageIcon(getClass().getResource("/images/" + "key.png")));
		...
		btnCancelar.setIcon(new ImageIcon(getClass().getResource("/images/" + "close.png")));
		...
		btnEntrar.setIcon(new ImageIcon(getClass().getResource("/images/" + "door.png")));
		...
		textFieldLogin.setBorder(BorderFactory.createCompoundBorder(textFieldLogin.getBorder(),
				BorderFactory.createEmptyBorder(5, 5, 5, 5)));
		panelForm2.add(textFieldLogin);
		textFieldLogin.setColumns(10);

		lblUsuarioSig.addMouseListener(new MouseAdapter() {
			@Override
		...
		passwordFieldSenha.setBorder(BorderFactory.createCompoundBorder(passwordFieldSenha.getBorder(),
				BorderFactory.createEmptyBorder(5, 5, 5, 5)));
		panelForm2.add(passwordFieldSenha);

		lblSenhaSig.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		lblUsuarioSig.setToolTipText("Digite o Usuário do Sigaa");
		lblSenhaSig.setToolTipText("Digite a senha");
		// acessiblidade para o leitor de tela
		lblUsuarioSig.getAccessibleContext().setAccessibleDescription("Digite o Usuário do Sigaa");
		lblSenhaSig.getAccessibleContext().setAccessibleDescription("Digite a senha");
		...
		JLabel labelLogo = new JLabel(
				"Sistema desenvolvido pelo laboratório de automação e tecnologias inovadoras - LABPATI");

		labelLogo.setIcon(new ImageIcon(getClass().getResource("/images/" + "logo_labpati3.png")));
		...
		labelLabIcone.setIcon(new ImageIcon(getClass().getResource("/images/" + "lab.png")));
		...
		labelPCIcone.setIcon(new ImageIcon(getClass().getResource("/images/" + "pc.png")));
		...
		labelIconeStatus.setIcon(new ImageIcon(getClass().getResource("/images/" + "link-quebrado.png")));
		...
		labelVersao.setBounds(233, 41, 62, 14);
		panelTopo.add(labelVersao);
	...
	public void setStatusConexao(boolean status) {
		if (status) {
			...
			labelIconeStatus.setIcon(new ImageIcon(getClass().getResource("/images/" + "link.png")));
		} else {
			panelStatus.setBackground(new Color(238, 65, 71));
			panelStatusIcone.setBackground(new Color(237, 50, 55));
			labelIconeStatus.setIcon(new ImageIcon(getClass().getResource("/images/" + "link-quebrado.png")));
	...
	public void statusUpdate() {
		panelStatus.setBackground(new Color(217, 217, 25));
		panelStatusIcone.setBackground(new Color(181, 165, 66));
		labelStatus.setText("Atualizando. Aguardande.");
		labelIconeStatus.setIcon(new ImageIcon(getClass().getResource("/images/" + "link.png")));
