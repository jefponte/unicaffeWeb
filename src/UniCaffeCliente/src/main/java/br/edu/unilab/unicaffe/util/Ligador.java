...
public class Ligador {
	...
	public void wol(byte[] MAC, String brodcast) throws IOException {
		...
		try {
			InetSocketAddress address = new InetSocketAddress(brodcast, 2304);
	 ...
	 * 
	 * @param args
	 *            MAC address in hex format. Non-hex characters are ignored. Must
	 *            end with Hex character. Example: &quot;00-50-12-34-56-78&quot;
	 */
