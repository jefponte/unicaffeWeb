...
public class FrameAviso extends JFrame {
	...
	public FrameAviso() {
		...
		labelAviso3.setIcon(new ImageIcon(getClass().getResource(UtilFrames.BASE_PATH_IMAGES + "relogio.png")));
		...
		labelAviso2.setIcon(new ImageIcon(getClass().getResource(UtilFrames.BASE_PATH_IMAGES + "relogio.png")));
		...
		labelAviso.setIcon(new ImageIcon(getClass().getResource(UtilFrames.BASE_PATH_IMAGES + "relogio.png")));
