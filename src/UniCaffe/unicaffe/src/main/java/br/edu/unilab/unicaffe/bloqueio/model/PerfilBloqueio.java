...
public class PerfilBloqueio {
	...
	public void buscaAceitos() {
		...
		this.listaDeProcessosAceitos.add(new Processo("GoogleCrashHandler.exe", "C:\\Program Files (x86)\\Google\\Update\\1.3.33.5\\GoogleCrashHandler.exe", "944"));
		this.listaDeProcessosAceitos.add(new Processo("GoogleCrashHandler64.exe", "C:\\Program Files (x86)\\Google\\Update\\1.3.33.5\\GoogleCrashHandler64.exe", "944"));
		this.listaDeProcessosAceitos.add(new Processo("putty.exe", "C:\\Program Files (x86)\\PuTTY\\putty.exe", "944"));
