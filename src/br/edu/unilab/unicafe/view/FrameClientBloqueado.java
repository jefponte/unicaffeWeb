...
public class FrameClientBloqueado extends JFrame {
	...
	private void initComponents() {
		...
		lblImgFormLogin.setIcon(new javax.swing.ImageIcon(
				new javax.swing.ImageIcon(getClass().getResource(
						UtilFrames.BASE_PATH_IMAGES + "fundoFormLogin.png"))
						.getImage()));
		...
		lblLogoUnicafe.setIcon(new javax.swing.ImageIcon(
				new javax.swing.ImageIcon(getClass().getResource(
						UtilFrames.BASE_PATH_IMAGES + "logoUnicafe.png"))
						.getImage()));
		...
		lblLogoUnilab
				.setIcon(new javax.swing.ImageIcon(new javax.swing.ImageIcon(
						getClass().getResource(
								UtilFrames.BASE_PATH_IMAGES
										+ "logoUnilabVertical.png")).getImage()));
		...
		lblLogoLabti.setIcon(new javax.swing.ImageIcon(
				new javax.swing.ImageIcon(getClass().getResource(
						UtilFrames.BASE_PATH_IMAGES + "logoLabti.png"))
						.getImage()));
		panel.add(lblLogoLabti, BorderLayout.NORTH);

		JPanelImageNormal panelImgFormLogin = new JPanelImageNormal();
		panelImgFormLogin.setPathImage(UtilFrames.BASE_PATH_IMAGES
				+ "fundoFormLogin.png");
		...
		gl_panelFormLogin.setHorizontalGroup(gl_panelFormLogin
				.createParallelGroup(Alignment.LEADING).addGroup(
						gl_panelFormLogin
								.createSequentialGroup()
								.addGap(285)
								.addComponent(panelImgFormLogin,
										GroupLayout.PREFERRED_SIZE, 777,
										GroupLayout.PREFERRED_SIZE)
								.addContainerGap(294, Short.MAX_VALUE)));
		gl_panelFormLogin.setVerticalGroup(gl_panelFormLogin
				.createParallelGroup(Alignment.LEADING).addGroup(
						gl_panelFormLogin
								.createSequentialGroup()
								.addGap(277)
		...
		try {
			bi = ImageIO.read(getClass().getResource(
					UtilFrames.BASE_PATH_IMAGES + "botaoEntrar.png"));
		...
		gl_panelImgFormLogin
				.setHorizontalGroup(gl_panelImgFormLogin
		...
		gl_panelImgFormLogin
				.setVerticalGroup(gl_panelImgFormLogin
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelImgFormLogin
										.createSequentialGroup()
