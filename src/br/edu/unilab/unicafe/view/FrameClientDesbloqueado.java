...
public class FrameClientDesbloqueado extends JFrame {
	...
	private void initComponents() {
		...
		ImgPanelFundo panel = new ImgPanelFundo(BASE_PATH_IMAGES + "fundoBarTarefas.jpg");
	    ...
	    BufferedImage bi;
		try {
			bi = ImageIO.read(getClass().getResource(BASE_PATH_IMAGES + "botaofinalizar.jpg"));
			// JButton
			...
			btnFinalizar.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent arg0) {
					...
					System.out.println("Clicou no botão Finalizar");
		...
		try {
			bi = ImageIO.read(getClass().getResource(BASE_PATH_IMAGES + "botaoChat.jpg"));
			// JButton
		...
		lblLogo.setIcon(new javax.swing.ImageIcon(new javax.swing.ImageIcon(getClass().getResource(BASE_PATH_IMAGES + "iconeBarra.png")).getImage()));
		...
		lblImgTime.setIcon(new javax.swing.ImageIcon(new javax.swing.ImageIcon(getClass().getResource(BASE_PATH_IMAGES + "relogio32x32.png")).getImage()));
		...
		lblImgUsuario.setIcon(new javax.swing.ImageIcon(new javax.swing.ImageIcon(getClass().getResource(BASE_PATH_IMAGES + "usuarios32x32.png")).getImage()));
