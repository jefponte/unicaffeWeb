...
class MenuView{
	...
	public function mostraMenuEspecial(){
			echo '	<div class="doze colunas barra-menu">
    <div class="menu-horizontal resolucao">
        <ol class="a-esquerda">
            <li><a href="index.php" class="item-ativo"><span class="icone-home3"></span> <span class="item-texto">Pagina Inicial</span></a></li>
			<li><a href="index.php?listarlab" class="item"><span class="icone-IE"></span> <span class="item-texto">Gerenciamento</span><span class="icone-expande"></span></a></li>
