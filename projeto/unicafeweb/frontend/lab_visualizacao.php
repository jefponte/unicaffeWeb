            ...
            <div class="doze colunas fundo-branco">
                <div class="duas colunas">
                    <div class="conteudo maquina borda-vermelho3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI01</h2>
                ...
                <div class="duas colunas">
                    <div class="conteudo maquina borda-verde3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI02</h2>
                        <div class="fundo-cinza1">
                            <div class="seis no-centro">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.602 109.602" style="enable-background:new 0 0 109.602 109.602;" xml:space="preserve">
                                    <g>
                        ...
                        <h3 class="titulo fundo-verde2"><span class="icone-user a-esquerda fundo-verde3"></span>livre</h3>
                        <h3 class="titulo fundo-verde2"><span class="icone-clock2 a-esquerda fundo-verde3"></span>--:--:--</h3>
                    </div>
                </div>
                <div class="duas colunas">
                    <div class="conteudo maquina borda-laranja3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI03</h2>
                        <div class="fundo-cinza1">
                            <div class="seis no-centro">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.602 109.602" style="enable-background:new 0 0 109.602 109.602;" xml:space="preserve">
                                    <g>
                        ...
                        <h3 class="titulo fundo-laranja2"><span class="icone-user a-esquerda fundo-laranja3"></span>giovanildo</h3>
                        <h3 class="titulo fundo-laranja2"><span class="icone-clock2 a-esquerda fundo-laranja3"></span>00:04:00</h3>
                    </div>
                </div>
                <div class="duas colunas">
                    <div class="conteudo maquina borda-azul3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI04</h2>
                        <div class="fundo-cinza1">
                            <div class="seis no-centro">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.602 109.602" style="enable-background:new 0 0 109.602 109.602;" xml:space="preserve">
                                    <g>
                                        <g>
                                            ...
                                            <g>
                                                <rect class="fill-azul2" x="0" y="34.652" style="fill:#939393;" width="71.577" height="46.525"/>
                                            </g>
                                            <g>
                                                <polygon style="fill:#939393;" points="25.052,85.279 17.894,92.436 53.683,92.436 46.525,85.279          "/>
                                            </g>
                        ...
                        <h3 class="titulo fundo-azul2"><span class="icone-book a-esquerda fundo-azul3"></span>aula</h3>
                        <h3 class="titulo fundo-azul2"><span class="icone-clock2 a-esquerda fundo-azul3"></span>--:--:--</h3>
                    </div>
                </div>
                <div class="duas colunas">
                    <div class="conteudo maquina borda-marrom3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI05</h2>
                        <div class="fundo-cinza1">
                            <div class="seis no-centro">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.602 109.602" style="enable-background:new 0 0 109.602 109.602;" xml:space="preserve">
                                    <g>
                                        <g>
                                            ...
                                            <g>
                                                <rect class="fill-marrom2" x="0" y="34.652" style="fill:#939393;" width="71.577" height="46.525"/>
                                            </g>
                                            <g>
                                                <polygon style="fill:#939393;" points="25.052,85.279 17.894,92.436 53.683,92.436 46.525,85.279          "/>
                                            </g>
                        ...
                        <h3 class="titulo fundo-marrom2"><span class="icone-wrench a-esquerda fundo-marrom3"></span>manutenção</h3>
                        <h3 class="titulo fundo-marrom2"><span class="icone-clock2 a-esquerda fundo-marrom3"></span>--:--:--</h3>
                    </div>
                </div>
                <div class="duas colunas">
                    <div class="conteudo maquina borda-cinza3">
                        <h2 class="titulo texto-cinza3 maiusculas centralizado fundo-cinza1">LABTI06</h2>
                        <div class="fundo-cinza1">
                            <div class="seis no-centro">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.602 109.602" style="enable-background:new 0 0 109.602 109.602;" xml:space="preserve">
                                    <g>
                        ...
                        <h3 class="titulo fundo-cinza2"><span class="icone-warning a-esquerda fundo-cinza3"></span>desligado/offline</h3>
                        <h3 class="titulo fundo-cinza2"><span class="icone-clock2 a-esquerda fundo-cinza3"></span>--:--:--</h3>
                    </div>
                </div>
                <div class="duas colunas">
                    <div class="conteudo maquina borda-vermelho3">
