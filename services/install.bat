...
set PR_CLASSPATH=c:\services\cliente.jar
REM Startup configuration
set PR_STARTUP=manual
set PR_STARTMODE=jvm
set PR_STARTCLASS=br.edu.unilab.unicafe.main.MainClient
set PR_STARTMETHOD=main
REM Shutdown configuration
set PR_STOPMODE=jvm
set PR_STOPCLASS=br.edu.unilab.unicafe.main.MainClient
...
REM Install service
prunsrv.exe //IS//%SERVICE_NAME% --Description="Servidor Unicafe"